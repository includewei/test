...
static float anchor_yolo_2layer[6][2] = {
...
void *yolov3t_postprocess(void *tensor_out, nn_tensor_param_t *param)
{
	...
	// set up anckor
	float *pAnchor = anchor_yolo_2layer;  // anchor_yolo_2layer, anchor_yolo_3layer
...
nnmodel_t yolov3_tiny = {
	...
	.set_confidence_thresh   = yolov3t_set_confidence_thresh,
	.set_nms_thresh     = yolov3t_set_nms_thresh,
