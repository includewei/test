...
void mmf2_video_example_av_init(void)
{
	...
	if (miso_video_aac_rtsp) {
		...
		miso_ctrl(miso_video_aac_rtsp, MMIC_CMD_SET_SECURE_CONTEXT, 1, 0);
#endif
...
static const char *example = "mmf2_video_example_av";
static void example_deinit(void)
{
	//Pause Linker
	miso_pause(miso_video_aac_rtsp, MM_OUTPUT);
	...
	//Delete linker
	miso_delete(miso_video_aac_rtsp);
